                    ...
                    <div class="mt-[70px] flex justify-center gap-[40px] flex-wrap">
                        ...
                        <div class="pricing-card">
                            ...
                            <form action="{{ route('member.transaction.store') }}" method="POST">
                                ...
                                <button
                                    type="submit"
                                    class="mt-10 p-3 block bg-red-400 outline outline-1 outline-stream-gray rounded-full text-center">
                        ...
                        <div class="pricing-card">
                            ...
                            <form action="{{ route('member.transaction.store') }}" method="POST">
                                ...
                                <button
                                    type="submit"
                                    class="mt-10 p-3 block bg-indigo-600 outline outline-1 outline-stream-gray rounded-full text-center">
