                    ...
                    <div class="mt-[70px] flex justify-center gap-[40px] flex-wrap">
                        ...
                        <div class="pricing-card">
                            ...
                            <form action="{{ route('member.transaction.store') }}" method="POST">
                                ...
                                <button
                                    type="submit"
                                    class="mt-10 p-3 block outline outline-1 outline-stream-gray rounded-full text-center">
                                    <span class="text-stream-black text-base font-normal">
                                        Subscribe
                                        Now
                                    </span>
                                </button>
                        ...
                        <div class="pricing-card">
                            ...
                            <form action="{{ route('member.transaction.store') }}" method="POST">
                                ...
                                <button
                                    type="submit"
                                    class="mt-10 p-3 block bg-indigo-600 rounded-full text-center">
                                    <span class="text-stream-white text-base font-normal">
                                        Subscribe
                                        Now
                                    </span>
                                </button>
